...
int main() {
  stdio_init_all();
  helper_init_all();  // Inicializa todos os periféricos

  // teste do buzzer, LED, e matriz de LED
  set_buzzer(true);
  set_heart(true);
  set_light(true);
  sleep_ms(100);
  ...
  add_repeating_timer_ms(1023, display_time_update_callback, NULL, &clock_timer);
